...
export default function BookReader() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a]">
      ...
      {/* Reader Container - Strict 6:5 Ratio */}
        ...
        <div className="w-full max-w-[1180px] aspect-[6/5] bg-[#f8f1e3] rounded-3xl overflow-hidden border-[16px] border-amber-950 shadow-2xl relative">
          ...
          <div className={`h-full overflow-auto p-12 md:p-16 ${readerClass} transition-all`}>
            <div className="max-w-3xl mx-auto pt-8">
              <h1 className="text-center text-5xl font-bold mb-6 text-balance">{book.title}</h1>
              ...
              >
                ...
                <p>Luke discovers a glowing key near the old bait shop and follows clues across the harbor. What adventures await in the Treehouse Mysteries?</p>
              </div>
            </div>
          </div>
      ...
      {/* Floating Controls - iPad Friendly */}
